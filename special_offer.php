...
<?php include('top.php'); ?>
    ...
    <section id="banner_so">
        <div class="banner_so">
            <img src="images/special offers/banner_res.jpg" alt="">
            <h2 id="txt6" class="txt">Special Offers</h2>
        </div>
    </section>

    <section class="spe_side">
      <div id="spe_side" class="row col-md-6">
        <img src="images/special offers/h0ICRU3zD11668484160.jpg" alt="">
      </div>
      <div id="spe_side" class="row col-md-6">
        <img src="images/special offers/Hh7A52eAHP1668483966.jpg" alt="">
      </div>
    </section>
    <section class="spe_side">
